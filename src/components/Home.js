  ...
  return (
    <div className="home">
      ...
      <div
        ...
        style={{ backgroundImage: "url(/containerVector.png)" }}
      >
        <h2>Our Products</h2>
        <div className="containerSecondCards">
          <Card name="Moms & Mini" img="1.jpeg" price={parseInt(1999)} key="1" />
          <Card name="Moms & Mini" img="21.jpeg" price={parseInt(1799)} key="2" />
        </div>
        <Link to="/products">View All</Link>
      </div>
      {/* <div className="containerThird" style={{ height: "600px" }}>
        <h2>Other Section</h2>
      </div> */}
    </div>
  );
